<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      ...
      <el-button class="filter-item" type="primary" icon="el-icon-search" @click="getOrderList">查找</el-button>
      <el-button
    ...
    >
      ...
      <el-table-column align="center" label="操作" width="200" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          ...
          <el-button
            v-if="scope.row.orderStatus == 0 ||scope.row.orderStatus == 1 ||scope.row.orderStatus == 2"
            type="primary"
            size="mini"
      ...
      <section ref="print">
        <el-form :data="orderDetail" label-position="left">
          ...
          <el-form-item label="费用信息">
            <span>
              (实际支付费用){{ orderDetail.order.actualPrice }}元
          ...
          <el-form-item label="快递信息">
            <span>
              （快递公司）
              <el-tag>{{ orderDetail.order.shipChannel | orderShipChannel }}</el-tag>
            </span>
...
// import * as channelsData from '@/utils/channels';
// import {
//   detailOrder,
//   listOrder,
//   listChannel,
...
export default {
  ...
  methods: {
    ...
    handleDetail(row) {
      ...
      orderApi.selectOne(params).then(response => {
    ...
    handleCancel(row) {
      // debugger
      this.cancelForm.orderId = row.id;
      this.cancelForm.orderStatus = 7;
      let params = {
        id: this.cancelForm.orderId,
        orderStatus: this.cancelForm.orderStatus
      };
      orderApi.update(params).then(res => {
        if (res.code == 1) {
