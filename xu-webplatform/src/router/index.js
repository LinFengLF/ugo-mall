...
const addUserInfo = () => import('@/views/user/addUserInfo.vue')
const editUserInfo = () => import('@/views/user/editUserInfo')
const editPassword = () => import('@/views/user/editPassword')
const goodsList = () => import('@/views/goods/goodsList')
const createGood = () => import('@/views/goods/createGood')
const editGood = () => import('@/views/goods/editGood')
const adList = () => import('@/views/promotion/ad')
const collectList = () => import('@/views/user/collect')
const region = () => import('@/views/mark/region')
const category = () => import('@/views/mark/category')
const address = () => import('@/views/user/address')
const order = () => import('@/views/order/order')
const comment = () => import('@/views/goods/comment')
...
let addRouter = [
  ...
  {
    path: '/',
    iconCls: 'fa fa-send-o', // 图标样式class
